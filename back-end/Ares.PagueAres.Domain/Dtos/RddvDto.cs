...
{
    public partial class RddvDto
    {
        public RddvDto()
        {
            Documentos = new List<DocumentoRddvDto>();
            Despesas = new List<DespesaRddvDto>();
        }
        ...
        public List<DespesaRddvDto> Despesas { get; set; }

        public List<DocumentoRddvDto> Documentos { get; set; }
    }
}
